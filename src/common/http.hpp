...
protected:
  // TODO(qleng): For now, Owned is implemented with shared_ptr and allows
  // copying. In the future, after Owned is implemented with unique_ptr,
  // it's necessary to replace copying with rvalue reference.
